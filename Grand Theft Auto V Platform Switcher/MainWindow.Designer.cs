namespace Grand_Theft_Auto_V_Platform_Switcher
{
	...
	public partial class MainWindow : global::System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.checkForUpdatesToolStripMenuItem.Text = "全面返工项目已启动，敬请期待……";
			...
			this.troubleshootingToolStripMenuItem.Text = "如何安装和使用";
			...
			this.lblRunAsAdmin.Text = "以管理员身份运行以启用锁定的按钮";
